...
describe('Service Tests', () => {
    ...
    describe('CandidateTrueSkill Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CandidateTrueSkillService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/candidate-true-skills';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CandidateTrueSkill', () => {
