...
public class ProfilResourceIntTest {
    ...
    public void setup() {
        ...
        final ProfilResource profilResource = new ProfilResource(profilRepository, profilSearchRepository);
    ...
    public void createProfil() throws Exception {
        ...
        assertThat(testProfil.getUserId()).isEqualTo(DEFAULT_USER_ID);

        // Validate the Profil in Elasticsearch
        Profil profilEs = profilSearchRepository.findOne(testProfil.getId());
        assertThat(profilEs).isEqualToIgnoringGivenFields(testProfil);
    }
    ...
    public void updateProfil() throws Exception {
        ...
        Profil testProfil = profilList.get(profilList.size() - 1);
        assertThat(testProfil.getUserId()).isEqualTo(UPDATED_USER_ID);
